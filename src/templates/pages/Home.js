    ...
    <section class="h-screen w-screen flex items-center justify-center">
		<div class="px-4 mx-auto max-w-7xl">
			<div class="mx-auto md:w-11/12 xl:w-9/12 text-center">
				<h1 class="text-3xl mb-4 font-extrabold leading-none tracking-normal text-gray-200 md:text-4xl md:tracking-tight">
				...
				<div class="flex justify-center">
					<p class="mb-9 px-6 py-2 rounded-full bg-neutral-700">
				...
				<div class="mb-4 space-x-0 md:space-x-2 md:mb-8">
					...
					<a href="https://github.com/fitri-hy/bee-framework/blob/main/README.md" class="inline-flex items-center justify-center hover:bg-neutral-950 w-full px-6 py-3 mb-2 text-lg bg-neutral-900 rounded-2xl sm:w-auto sm:mb-0">
						Get Started
